...
Write-Host ""
Write-Host "4. Prepared questions ([SKILL_QUESTIONS] contract, offline)" -ForegroundColor White
...
foreach ($t in @("preset","preflight","clarify","all")) {
  ...
  Check "questions -Type $t valid block" { Test-Questions "openvino-content-fetch" $qo }
}
