...
material, or a runnable, optimized, served demo — by orchestrating the four skills below. Everything
...
| [`openvino-content-fetch`](openvino-content-fetch/) | Fetch, parse, and index notebooks / samples / models / articles from GitHub, ModelScope AI PC Zone, and CSDN; returns a structured `[SKILL_RESULT]`. |
| [`openvino-resource-download`](openvino-resource-download/) | Browse the ModelScope Intel AI PC Zone — latest news, models, skills, articles, events, and application notebooks. |
