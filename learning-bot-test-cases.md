...
| N6 | 离线假设 | "我在中国大陆、没有 VPN，把环境都配好。" | Citizen | **ENV/RES/… 带 `--china`** | 应用 `--china`（国内镜像：pip/ModelScope/HF/GitCode）；不假设可直连 GitHub/HF。 |
...
- **Skill：** ENV（S1, M1, M4, U3, N6, L1）、RES（S2, M3, B3, …）、PIPE（S3, M2–M6, P1, N5, L2, …）、FETCH（S4, M1/M2/M4, U1–U4, …）—— 四个全覆盖。
